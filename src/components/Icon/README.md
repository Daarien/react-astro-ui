...
```jsx
<div>
  <Icon glyph="logo" intent="primary" />
  <Icon glyph="done" intent="success" />
  <Icon glyph="phone_outline" intent="danger" />
  <Icon glyph="call" intent="info" />
  <Icon glyph="close" intent="warning" />
</div>
```
...
```jsx
<div>
  <Icon glyph="logo" intent="primary" inverted />
  <Icon glyph="done" intent="success" inverted />
  <Icon glyph="call_end" intent="danger" inverted />
  <Icon glyph="link" intent="info" inverted />
  <Icon glyph="close" intent="warning" inverted />
</div>
```
...
```jsx
<div>
  <Icon glyph="logo" intent="primary" size="small" />
  <Icon glyph="done" intent="success" size="small" inverted />
  <Icon glyph="notifications" intent="info" />
  <Icon glyph="call" intent="danger" inverted />
  <Icon glyph="plus_outline" intent="info" size="large" />
  <Icon glyph="link" intent="warning" width={60} height={60} inverted />
</div>
```
...
```jsx
<div>
  <Icon glyph="logo" intent="primary" inverted onClick={() => {}} />
  <Icon glyph="done" intent="success" onClick={() => {}} />
  <Icon glyph="notifications" intent="danger" inverted onClick={() => {}} />
  <Icon glyph="phone_outline" intent="info" size="large" onClick={() => {}} />
  <Icon
    glyph="person"
    intent="warning"
    size="large"
